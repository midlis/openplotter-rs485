...
class MyFrame(wx.Frame):
	def __init__(self):
		...
		self.language = language.Language(self.currentdir,'openplotter-rs485',self.currentLanguage)

		wx.Frame.__init__(self, None, title='RS485 '+version, size=(800,444))
		self.SetFont(wx.Font(10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL))
		icon = wx.Icon(self.currentdir+"/data/openplotter-rs485.png", wx.BITMAP_TYPE_PNG)
		self.SetIcon(icon)
		...
		self.notebook.AddPage(self.myapp, 'RS485')
	...
	def OnToolHelp(self, event):
		url = "/usr/share/doc/openplotter-rs485/rs485_app.html"
...
def main():
	try:
		...
		if not platform2.postInstall(version,'rs485'):
			subprocess.Popen(['openplotterPostInstall', platform2.admin+' rs485PostInstall'])
			return
	except: pass
